...
#
# Usage:
#   ./scripts/send-traces.sh                            # uses fixtures/sample_trace.json on :4318
...
# 4318). Run the app, then run this script in a second terminal — the
# workbench should immediately surface the new trace.
