...
Download `SHA256SUMS` and one package from the [v0.1.16 GitHub Release](https://github.com/b1tank/otelux/releases/tag/v0.1.16).
...
For Linux arm64, use `OTelux-0.1.16-arm64.deb` or `OTelux-0.1.16-arm64.AppImage` and the matching checksum line.
