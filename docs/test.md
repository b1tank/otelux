...
- Desktop main/preload integration tests cover settings validation and migration, port rebinding, rollback after bind or persistence failure, IPC request and method-specific result validation, lifecycle cleanup, and the exposed context-bridge surface.
