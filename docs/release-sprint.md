...
- [ ] Complete clear-data and any remaining result-state work required from [plan.md Phase 1](plan.md#phase-1--workbench-polish) (pause/resume live-tail and result footers are shipped); other Phase 1 polish remains risk-ranked rather than automatically blocking.
